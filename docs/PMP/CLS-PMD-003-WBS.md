...
| 2026-07-08 | Client editor slice 3 Serve push (serve_catalog re-scan+register, dirty-guard, frontend wiring + verify) (1.2.41) | Lead Developer | 1.5 |
| 2026-07-08 | Client editor slice 4 cover picker (set_cover/embed_cover/mime via lofty + Tauri image dialog + whole-release apply) + register release.cover_url from track cover (1.2.41) | Lead Developer | 2.5 |
...
| 2026-07-08 | Dossier player standardize (waveform->progress bar) + discography sidebar follows-playing + now-playing highlight; dev-preview debugging + prod deploy-verify (1.2.43) | Lead Developer | 2.0 |
| 2026-07-08 | Player/sidebar verification (dev-preview thrash isolation, served-bundle checks, prod deploy-verify) (1.2.43) | QA Engineer | 0.5 |
| 2026-07-08 | Label vs managed-imprint design (venue vs label; admin-granted credential rule) (1.2.44) | Solutions Architect | 0.5 |
| 2026-07-08 | Artist label + managed imprint build: mig 0025 + db helper + dossier render + artist editor + admin toggle + managed-tier guard (8 files) (1.2.44) | Lead Developer | 2.5 |
